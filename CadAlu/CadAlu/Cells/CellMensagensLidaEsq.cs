...
{
    internal class CellMensagensLidaEsq : ViewCell
    {
        public int Alinhamento { get; set; }
        public CellMensagensLidaEsq()
        {
            var grid = new Grid
            {
            ...
            Label lblAssunto = new Label { FontAttributes = FontAttributes.None, FontSize = 18, HorizontalOptions = LayoutOptions.End, VerticalOptions = LayoutOptions.Center };
